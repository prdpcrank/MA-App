 ...
 */
public abstract class Hilt_DetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DetailsFragment_GeneratedInjector) this.generatedComponent()).injectDetailsFragment(UnsafeCasts.<DetailsFragment>unsafeCast(this));
    }
  }
